            ...
            <div className="space-y-8">
              ...
              <div>
                ...
                <ul className="list-disc ml-6 text-gray-700 space-y-2">
                  <li>
                    <span className="font-semibold">Short-Term:</span> OBBBA's tax cut extensions provide a modest short-term boost to GDP (e.g., <span className="text-blue-600">+0.6%</span> in 2026 per <a href="https://taxpolicycenter.org/taxvox/houses-one-big-beautiful-bill-modestly-boosts-short-term-growth-hurts-long-term-outlook" className="underline" target="_blank" rel="noopener noreferrer">Tax&nbsp;Policy&nbsp;Center</a>), but these gains fade as higher debt and interest rates offset the stimulus.
                  </li>
                  <li>
                  <span className="font-semibold">Long-Term:</span> Most independent analyses (<a href="https://www.cbo.gov/publication/61486" className="underline" target="_blank" rel="noopener noreferrer">CBO</a>, <a href="https://www.crfb.org/blogs/how-much-would-obbba-pay-itself" className="underline" target="_blank" rel="noopener noreferrer">CRFB</a>, <a href="https://taxfoundation.org/blog/infrastructure-spending-corporate-tax/" className="underline" target="_blank" rel="noopener noreferrer">Tax Foundation</a>) project only a <span className="text-blue-600">0.4–0.8%</span> increase in GDP over decades, with most of the bill’s cost not offset by growth. By 2049, higher debt could actually <span className="text-red-600">reduce GDP</span> below baseline.
                  </li>
                  <li>
